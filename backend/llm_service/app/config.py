...
SYSTEM_PROMPT_RU = (
    ...
    "Задача: преврати глоссы в грамматически правильное предложение на РУССКОМ языке. "
...
SYSTEM_PROMPT_KZ = (
    ...
    "Міндет: глоссалардың мағынасын ҚАЗАҚ тілінде грамматикалық дұрыс сөйлеммен жеткіз. "
...
SYSTEM_PROMPT_EN = (
    ...
    "Task: convey the meaning of the glosses as a grammatically correct ENGLISH sentence. "
