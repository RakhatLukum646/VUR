          ...
          <div className="flex items-center gap-2 sm:gap-4 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-baseline gap-1 min-w-0">
                <span className="text-lg sm:text-2xl font-bold tracking-tight text-indigo-700 dark:text-indigo-400">
                  Sign
                </span>
                <span className="text-lg sm:text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">
                  Zhan
                </span>
              </div>
              <p className="text-xs text-gray-600 dark:text-gray-300 leading-snug truncate max-w-[180px] sm:max-w-none">
                {t.nav.tagline}
              </p>
            </div>
          </div>
